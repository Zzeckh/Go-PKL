  ...
  return (
    <div className="h-full w-full flex flex-col gap-3 md:gap-4 overflow-y-auto custom-scrollbar">
      ...
      {/* ══════════════════════════════════════════════════
          HEADER
          ══════════════════════════════════════════════════ */}
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 shrink-0 bg-white rounded-[24px] p-4 md:p-5 border border-mist/60 shadow-sm">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end gap-2 shrink-0">
          ...
          <button
            ...
            className="flex items-center justify-center gap-1.5 bg-steel text-white text-xs font-bold px-4 py-2.5 rounded-[24px] shadow-md shadow-steel/25 hover:bg-steel/90 hover:-translate-y-0.5 transition-all shrink-0 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:translate-y-0"
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3">
              ...
              {filtered.length === 0 ? (
                ...
                filtered.map(c => (
                  ...
                  <div
                    key={c.id}
                    className="p-4 rounded-[24px] border border-mist/60 bg-white hover:border-steel/30 hover:shadow-sm transition-all flex flex-col"
                  >
    ...
    <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center p-3 sm:p-4 bg-navy/50 backdrop-blur-md">
      ...
      <div className="bg-white rounded-t-[24px] sm:rounded-[24px] max-w-md w-full shadow-2xl border border-mist/60 max-h-[90vh] flex flex-col overflow-hidden">
        ...
        <form
          ...
          className="p-4 sm:p-5 space-y-3 overflow-y-auto flex-1"
        >
          ...
          <div className="flex gap-2 pt-2">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex-1 bg-steel text-white font-bold text-sm py-3 rounded-[24px] hover:bg-steel/90 shadow-lg shadow-steel/25 disabled:opacity-60 transition-all"
            >
              {loading
                ? 'Menyimpan...'
                : 'Simpan'}
        ...
        <div className="p-4 sm:p-5 border-b border-mist/60 flex items-center justify-between shrink-0">
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <h3 className="text-lg font-bold text-navy leading-tight truncate">
                {detail.name}
              </h3>
          ...
          {loading ? (
            ...
            <div className="space-y-2">
              ...
              {students.map((s: any) => (
                ...
                <div
                  key={s.id}
                  className="p-3 rounded-[24px] border border-mist/60 bg-white flex items-center gap-3 hover:border-steel/30 transition-colors"
                >
