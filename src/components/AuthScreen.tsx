...
export const AuthScreen: React.FC<AuthScreenProps> = ({
  ...
  const formProps = {
    ...
    onSwitch: () => setAuthMode(isLogin ? 'register' : 'login'),
    isLoading
  };
...
// ==========================================
const AuthForm = ({ mode, showPassword, setShowPassword, name, setName, email, setEmail, password, setPassword, institution, setInstitution, onSubmit, onSwitch, isLoading }: any) => {
...
// ==========================================
const MobileForm = ({ mode, showPassword, setShowPassword, name, setName, email, setEmail, password, setPassword, institution, setInstitution, onSubmit, onSwitch, isLoading }: any) => {
  const isLogin = mode === 'login';
  return (
