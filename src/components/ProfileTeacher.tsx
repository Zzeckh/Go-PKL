...
export const ProfileTeacher: React.FC = () => {
  const { userName, schoolName } = useApp();
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:flex-1 lg:min-h-0">
            <div className="bg-navy rounded-[24px] p-5 flex flex-col relative overflow-hidden">
              ...
              <div className="relative z-10 flex-1">
                <p className="text-[10px] font-bold text-white/50 uppercase tracking-widest mb-4">Informasi Sekolah</p>
                <div className="flex flex-col gap-4">
                  <div>
                    <h4 className="text-xl font-bold text-white mb-1">{profile.company}</h4>
                    <p className="text-xs text-white/70">Sekolah Menengah Kejuruan</p>
                  </div>
                  <div>
                    <p className="text-[10px] font-bold text-white/50 uppercase tracking-wide mb-1">Total Siswa PKL</p>
                    <p className="text-sm font-bold text-white">45 Siswa Aktif</p>
                  </div>
                  <div>
            ...
            <div className="bg-shell rounded-[24px] border border-mist p-5 flex flex-col gap-4 overflow-y-auto custom-scrollbar">
              <p className="text-[10px] font-bold text-navy/40 uppercase tracking-widest mb-1">Sebaran Kelas</p>
              {[
                { icon: Users, label: 'XII RPL 1', value: '15 Siswa' },
                { icon: Users, label: 'XII RPL 2', value: '15 Siswa' },
                { icon: Users, label: 'XII TKJ 1', value: '15 Siswa' },
