...
import { X, Search, ChevronRight, Activity, GraduationCap, Building, Calendar, AlertCircle, Clock } from 'lucide-react';
...
/* ══════════════════════════════════════════════════════
   ...
   ✅ Card list design + stats navy chip + modal per siswa
   ══════════════════════════════════════════════════════ */
export const MentorKehadiran: React.FC = () => {
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        <span className="text-[11px] font-semibold text-navy/50 truncate">{s.kelas || '-'}</span>
                        <span className="w-1 h-1 rounded-full bg-navy/20 shrink-0" />
                        <span className="text-[11px] font-semibold text-navy/50 truncate">{s.perusahaan || '-'}</span>
                      </div>
...
/* ══════════════════════════════════════════════════════
   ...
   ✅ riwayat difilter per siswa, badge solid, progress visual
   ══════════════════════════════════════════════════════ */
