...
export const HubinDashboard: React.FC<HubinDashboardProps> = ({
  schoolName,
  onNavigate,
}) => {
  const {
          ...
          <div className="bg-white rounded-[24px] border border-mist/60 shadow-sm p-4 shrink-0">
            ...
            {mode === 'clock' ? (
              ...
              <div className="flex flex-col items-center justify-center gap-3 py-4">
                ...
                <span className="text-4xl md:text-5xl font-light text-navy font-mono tabular-nums">
                  {fmtSw(sw)}
                </span>
            ...
            <div className="flex items-center justify-between p-5 pb-3 shrink-0">
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[11px] font-bold uppercase tracking-widest text-navy/60 leading-none">
                    Catatan
                  </p>

                  <p className="text-sm font-bold text-navy leading-tight mt-0.5">
                    Notes Hubin
                  </p>
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className={`w-8 h-8 rounded-[10px] flex items-center justify-center border transition-all ${
                    editNotes
                      ? 'bg-navy text-white border-navy shadow-md shadow-navy/30'
            ...
            <div className="lg:flex-1 px-5 pb-5 lg:min-h-0 flex flex-col">
              ...
              {editNotes ? (
                ...
                <div className="w-full lg:flex-1 min-h-[120px] max-h-56 lg:max-h-none overflow-y-auto custom-scrollbar text-sm font-medium text-navy/80 whitespace-pre-line leading-relaxed">
                  ...
                  {notes || (
                    <span className="text-navy/40 italic text-xs">
                      Belum ada catatan.
                    </span>
                  )}
